...
for t_idx, track in enumerate(tracks):
    ...
    for p_idx, pub in enumerate(publishers, start=1):
        ...
        # mr_share and sr_share for original publisher are ALWAYS 10000
        # regardless of CSV value. Confirmed from Chris's approved files.
        # CSV value (50%) represents collection share, not MR ownership.
        mr_share = "10000"
        sr_share = "10000"
        ...
        # mr_coll and sr_coll ALWAYS 10000. Confirmed from Chris's approved files.
...
“”“Format society code. Handles both numeric codes and society names.”””
import re
SOCIETY_LOOKUP = {
‘BMI’: ‘021’, ‘ASCAP’: ‘021’, ‘SESAC’: ‘055’,
‘PRS’: ‘052’, ‘MCPS’: ‘033’, ‘PRSFORMUSIC’: ‘052’,
‘GEMA’: ‘035’, ‘SACEM’: ‘058’, ‘SOCAN’: ‘022’,
‘APRA’: ‘065’, ‘AMCOS’: ‘065’, ‘SIAE’: ‘056’,
‘STIM’: ‘079’, ‘KODA’: ‘040’, ‘TEOSTO’: ‘089’,
‘JASRAC’: ‘099’, ‘KOMCA’: ‘098’, ‘SAMRO’: ‘072’,
‘IMRO’: ‘039’, ‘SUISA’: ‘088’, ‘BUMA’: ‘023’,
‘STEMRA’: ‘023’, ‘SABAM’: ‘070’, ‘SGAE’: ‘073’,
}
if not value:
return ‘000’
v = str(value).strip().upper().replace(’ ‘, ‘’).replace(’/’, ‘’)
if v in SOCIETY_LOOKUP:
return SOCIETY_LOOKUP[v]
for name, code in SOCIETY_LOOKUP.items():
if name in v:
return code
